...
namespace MemCheck.CommandLineDbClient.Pauker
{
    internal sealed class BeaufortCardCreator : IMemCheckTest
    {
        ...
        private async Task GenerateMinSpeedForNameAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            var request = new CreateCard.Request(userId, frontSide, Array.Empty<Guid>(), backSide, Array.Empty<Guid>(), additionalInfo, Array.Empty<Guid>(), frenchLanguageId, new[] { tagId }, Array.Empty<Guid>(), CardVersionDescription);
        ...
        private async Task GenerateSpeedMiddleForNumberAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            CreateCard.Request? request = new CreateCard.Request(userId, frontSide, Array.Empty<Guid>(), backSide, Array.Empty<Guid>(), additionalInfo, Array.Empty<Guid>(), frenchLanguageId, new[] { tagId }, Array.Empty<Guid>(), CardVersionDescription);
            await new CreateCard(dbContext).RunAsync(request, new FakeStringLocalizer());
        }
        ...
        private async Task GenerateNameFromSpeedAsync(int windSpeed, BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            CreateCard.Request? request = new CreateCard.Request(userId, frontSide, Array.Empty<Guid>(), $"_{f.Name}_", Array.Empty<Guid>(), additionalInfo, Array.Empty<Guid>(), frenchLanguageId, new[] { tagId }, Array.Empty<Guid>(), CardVersionDescription);
            await new CreateCard(dbContext).RunAsync(request, new FakeStringLocalizer());
        }
        private async Task GenerateNumberFromSpeedAsync(int windSpeed, BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            var request = new CreateCard.Request(userId, frontSide, Array.Empty<Guid>(), $"{f.Number}", Array.Empty<Guid>(), additionalInfo, Array.Empty<Guid>(), frenchLanguageId, new[] { tagId }, Array.Empty<Guid>(), CardVersionDescription);
            await new CreateCard(dbContext).RunAsync(request, new FakeStringLocalizer());
        }
        private async Task GenerateNameFromNumberAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            var request = new CreateCard.Request(userId, frontSide, Array.Empty<Guid>(), $"_{f.Name}_", Array.Empty<Guid>(), additionalInfo, Array.Empty<Guid>(), frenchLanguageId, new[] { tagId }, Array.Empty<Guid>(), CardVersionDescription);
            await new CreateCard(dbContext).RunAsync(request, new FakeStringLocalizer());
        }
        private async Task GenerateNumberFromNameAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            var request = new CreateCard.Request(userId, frontSide, Array.Empty<Guid>(), $"_{f.Number}_", Array.Empty<Guid>(), additionalInfo, Array.Empty<Guid>(), frenchLanguageId, new[] { tagId }, Array.Empty<Guid>(), CardVersionDescription);
            await new CreateCard(dbContext).RunAsync(request, new FakeStringLocalizer());
        }
