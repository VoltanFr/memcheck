...
namespace MemCheck.CommandLineDbClient.Pauker
{
    internal sealed class BeaufortCardCreator : IMemCheckTest
    {
        ...
        private async Task GenerateMinSpeedForNameAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            var request = new CreateCard.Request(userId, frontSide, new Guid[0], backSide, new Guid[0], additionalInfo, new Guid[0], frenchLanguageId, new[] { tagId }, new Guid[0], CardVersionDescription);
        ...
        private async Task GenerateNameFromSpeedAsync(int windSpeed, BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            var request = new CreateCard.Request(userId, frontSide, new Guid[0], $"_{f.Name}_", new Guid[0], additionalInfo, new Guid[0], frenchLanguageId, new[] { tagId }, new Guid[0], CardVersionDescription);
            await new CreateCard(dbContext).RunAsync(request, new FakeStringLocalizer());
        }
        private async Task GenerateNumberFromSpeedAsync(int windSpeed, BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            var request = new CreateCard.Request(userId, frontSide, new Guid[0], $"{f.Number}", new Guid[0], additionalInfo, new Guid[0], frenchLanguageId, new[] { tagId }, new Guid[0], CardVersionDescription);
            await new CreateCard(dbContext).RunAsync(request, new FakeStringLocalizer());
        }
        ...
        private async Task GenerateNumberFromNameAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
        {
            ...
            var request = new CreateCard.Request(userId, frontSide, new Guid[0], $"_{f.Number}_", new Guid[0], additionalInfo, new Guid[0], frenchLanguageId, new[] { tagId }, new Guid[0], CardVersionDescription);
            await new CreateCard(dbContext).RunAsync(request, new FakeStringLocalizer());
        }
