...
internal sealed class BeaufortCardCreator : ICmdLinePlugin
{
    ...
    private async Task GenerateMinSpeedForNameAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
    {
        ...
        var request = new CreateCard.Request(userId, frontSide, backSide, additionalInfo, "", frenchLanguageId, tagId.AsArray(), Array.Empty<Guid>(), CardVersionDescription);
    ...
    private async Task GenerateSpeedMiddleForNumberAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
    {
        ...
        CreateCard.Request request = new(userId, frontSide, backSide, additionalInfo, "", frenchLanguageId, tagId.AsArray(), Array.Empty<Guid>(), CardVersionDescription);
        await new CreateCard(dbContext.AsCallContext()).RunAsync(request);
    }
    ...
    private async Task GenerateNameFromSpeedAsync(int windSpeed, BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
    {
        ...
        CreateCard.Request request = new(userId, frontSide, $"_{f.Name}_", additionalInfo, "", frenchLanguageId, tagId.AsArray(), Array.Empty<Guid>(), CardVersionDescription);
        await new CreateCard(dbContext.AsCallContext()).RunAsync(request);
    }
    private async Task GenerateNumberFromSpeedAsync(int windSpeed, BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
    {
        ...
        var request = new CreateCard.Request(userId, frontSide, $"{f.Number}", additionalInfo, "", frenchLanguageId, tagId.AsArray(), Array.Empty<Guid>(), CardVersionDescription);
        await new CreateCard(dbContext.AsCallContext()).RunAsync(request);
    }
    private async Task GenerateNameFromNumberAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
    {
        ...
        var request = new CreateCard.Request(userId, frontSide, $"_{f.Name}_", additionalInfo, "", frenchLanguageId, tagId.AsArray(), Array.Empty<Guid>(), CardVersionDescription);
        await new CreateCard(dbContext.AsCallContext()).RunAsync(request);
    }
    private async Task GenerateNumberFromNameAsync(BeaufortForce f, Guid userId, Guid frenchLanguageId, Guid tagId)
    {
        ...
        var request = new CreateCard.Request(userId, frontSide, $"_{f.Number}_", additionalInfo, "", frenchLanguageId, tagId.AsArray(), Array.Empty<Guid>(), CardVersionDescription);
        await new CreateCard(dbContext.AsCallContext()).RunAsync(request);
    }
