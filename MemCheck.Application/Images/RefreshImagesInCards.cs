...
public sealed class RefreshImagesInCards : RequestRunner<RefreshImagesInCards.Request, RefreshImagesInCards.Result>
{
    ...
    protected override async Task<ResultWithMetrologyProperties<Result>> DoRunAsync(Request request)
    {
        ...
        var nonExistingImagesInCardsInTheDb = DbContext.ImagesInCards.Where(imageInCard => !DbContext.Images.Any(img => img.Id == imageInCard.ImageId)).ToImmutableArray();
        ...
        return new ResultWithMetrologyProperties<Result>(new Result(imageIdsFromNames.Count, totalCardCount, imagesInCardsInTheDb.Length, imagesInCardsCountOnEnd),
    ...
    public sealed record Result(int TotalImageCount, int TotalCardCount, int ImagesInCardsCountOnStart, int ImagesInCardsCountOnEnd);
    #endregion
}
