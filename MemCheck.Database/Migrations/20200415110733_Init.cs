...
public partial class Init : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_CardLanguages", x => x.Id);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                UILanguage = table.Column<string>(nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_TagsInCards", x => new { x.CardId, x.TagId });
                table.ForeignKey(
                    name: "FK_TagsInCards_Cards_CardId",
                    column: x => x.CardId,
                    principalTable: "Cards",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
                table.ForeignKey(
                    name: "FK_TagsInCards_Tags_TagId",
                    column: x => x.TagId,
                    principalTable: "Tags",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                CurrentHeap = table.Column<int>(nullable: false),
                LastLearnTime = table.Column<DateTime>(nullable: false),
                NbTimesInNotLearnedHeap = table.Column<int>(nullable: false),
                BiggestHeapReached = table.Column<int>(nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_CardsInDecks", x => new { x.CardId, x.DeckId });
                table.ForeignKey(
