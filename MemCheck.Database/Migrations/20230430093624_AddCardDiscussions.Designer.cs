...
namespace MemCheck.Database.Migrations
{
    ...
    [Migration("20230430093624_AddCardDiscussions")]
    partial class AddCardDiscussions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemCheck.Domain.Card", b =>
                {
                    ...
                    b.Property<Guid?>("LatestDiscussionEntryId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("WholeText")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("[FrontSide] + [BackSide] + [AdditionalInfo] + [References]", true);

                    b.HasKey("Id");

                    b.HasIndex("CardLanguageId");

                    b.HasIndex("LatestDiscussionEntryId");

                    b.HasIndex("PreviousVersionId");

                    b.HasIndex("VersionCreatorId");

                    b.HasIndex("VersionUtcDate");

                    b.ToTable("Cards");
                });

            modelBuilder.Entity("MemCheck.Domain.CardDiscussionDeletedEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("DeletetionAuthorId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("DeletetionUtcDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("DeletetionAuthorId");

                    b.HasIndex("PreviousVersionId");

                    b.ToTable("CardDiscussionDeletedEntries");
                });

            modelBuilder.Entity("MemCheck.Domain.CardDiscussionEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CardDiscussionEntries");
                });

            modelBuilder.Entity("MemCheck.Domain.CardDiscussionEntryPreviousVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CardDiscussionEntryPreviousVersions");
                });
            ...
            modelBuilder.Entity("MemCheck.Domain.TagPreviousVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MemCheck.Domain.Card", b =>
                {
                    ...
                    b.HasOne("MemCheck.Domain.CardDiscussionEntry", "LatestDiscussionEntry")
                        .WithMany()
                        .HasForeignKey("LatestDiscussionEntryId");
                    ...
                    b.Navigation("LatestDiscussionEntry");
            ...
            modelBuilder.Entity("MemCheck.Domain.CardDiscussionDeletedEntry", b =>
                {
                    b.HasOne("MemCheck.Domain.MemCheckUser", "DeletetionAuthor")
                        .WithMany()
                        .HasForeignKey("DeletetionAuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MemCheck.Domain.CardDiscussionEntryPreviousVersion", "PreviousVersion")
                        .WithMany()
                        .HasForeignKey("PreviousVersionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("DeletetionAuthor");
            ...
            modelBuilder.Entity("MemCheck.Domain.CardDiscussionEntry", b =>
                {
                    b.HasOne("MemCheck.Domain.MemCheckUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MemCheck.Domain.CardDiscussionEntry", "PreviousEntry")
                        .WithMany()
            ...
            modelBuilder.Entity("MemCheck.Domain.Tag", b =>
                {
                    b.HasOne("MemCheck.Domain.MemCheckUser", "CreatingUser")
                        .WithMany()
                        .HasForeignKey("CreatingUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("MemCheck.Domain.TagPreviousVersion", "PreviousVersion")
                        .WithMany()
                        .HasForeignKey("PreviousVersionId");
