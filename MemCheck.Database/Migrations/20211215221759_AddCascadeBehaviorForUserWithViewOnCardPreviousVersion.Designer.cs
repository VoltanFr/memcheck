...
namespace MemCheck.Database.Migrations
{
    ...
    [Migration("20211215221759_AddCascadeBehaviorForUserWithViewOnCardPreviousVersion")]
    partial class AddCascadeBehaviorForUserWithViewOnCardPreviousVersion
    {
            ...
            modelBuilder.Entity("MemCheck.Domain.CardInDeck", b =>
                {
                    ...
                    b.HasIndex("DeckId", "CurrentHeap", "CardId")
                        .HasAnnotation("SqlServer:Include", new[] { "AddToDeckUtcTime", "BiggestHeapReached", "LastLearnUtcTime", "NbTimesInNotLearnedHeap" });

                    b.HasIndex("DeckId", "CurrentHeap", "ExpiryUtcTime")
                        .HasAnnotation("SqlServer:Include", new[] { "AddToDeckUtcTime", "BiggestHeapReached", "CardId", "LastLearnUtcTime", "NbTimesInNotLearnedHeap" });
            ...
            modelBuilder.Entity("MemCheck.Domain.UserCardRating", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasAnnotation("SqlServer:Include", new[] { "Rating" });
