...
public class UpdateDeckTests
{
    ...
    public async Task UserNotLoggedIn()
    {
        ...
        await Assert.ThrowsExactlyAsync<InvalidOperationException>(async () => await new UpdateDeck(dbContext.AsCallContext()).RunAsync(request));
    }
    [TestMethod()]
    ...
    public async Task NameTooShort()
    {
        ...
        await Assert.ThrowsExactlyAsync<RequestInputException>(async () => await new UpdateDeck(dbContext.AsCallContext()).RunAsync(request));
    }
    [TestMethod()]
