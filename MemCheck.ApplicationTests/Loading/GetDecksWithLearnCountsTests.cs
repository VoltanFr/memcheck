...
namespace MemCheck.Application.Loading
{
    ...
    public class GetDecksWithLearnCountsTests
    {
        ...
        public async Task OneCardToExpireTomorrow()
        {
            ...
            using (var dbContext = new MemCheckDbContext(testDB))
            {
                var resultOn10 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2030, 01, 10))).First();
                ...
                var resultOn11 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2030, 01, 11))).First();
                ...
                var resultOn12 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2030, 01, 12, 0, 0, 0))).First();
                ...
                var resultOn12_13 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2030, 01, 12, 13, 0, 0))).First();
        ...
        public async Task OneCardToExpireThisWeek()
        {
            ...
            using (var dbContext = new MemCheckDbContext(testDB))
            {
                var resultOn20 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2020, 12, 20))).First();
                ...
                var resultOn21 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2020, 12, 21))).First();
                ...
                var resultOn22 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2020, 12, 22))).First();
                ...
                var resultOn23 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2020, 12, 23))).First();
                ...
                var resultOn24 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2020, 12, 24))).First();
                ...
                var resultOn25 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2020, 12, 25))).First();
                ...
                var resultOn26 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2020, 12, 26))).First();
                ...
                var resultOn27 = (await new GetDecksWithLearnCounts(dbContext).RunAsync(new GetDecksWithLearnCounts.Request(userId), new DateTime(2020, 12, 27, 0, 0, 0))).First();
