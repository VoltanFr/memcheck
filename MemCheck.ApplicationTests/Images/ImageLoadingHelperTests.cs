...
{
    [TestMethod, DataRow(""), DataRow("x"), DataRow("[hop]"), DataRow("[Mnesios:img]"), DataRow("![Mnesios]"), DataRow("![Mnesio:img]"), DataRow("![Mnesio:img,size=bad]")]
    ...
    [TestMethod, DataRow("`![Mnesios:img]`"), DataRow("`![Mnesios:An image]`"), DataRow("text before `![Mnesios:a-b]`"),
    ...
    [TestMethod, DataRow("![Mnesios:img]", "img"), DataRow("![Mnesios:An image]", "An image"), DataRow("text before ![Mnesios:a-b]", "a-b"),
    ...
    {
        var imageNames = ImageLoadingHelper.GetMnesiosImagesFromText(text);
        Assert.HasCount(1, imageNames);
        Assert.AreEqual(imageName, imageNames.First());
    }
    [TestMethod, DataRow("![Mnesios:img,size=small]", "img"), DataRow("![Mnesios:An image,size=medium]", "An image"), DataRow("text before ![Mnesios:a-b,size=big]", "a-b"),
