...
//{
//    public UpdateTagStats(TelemetryConfiguration telemetryConfiguration, MemCheckDbContext memCheckDbContext, MemCheckUserManager userManager)
//        : base(telemetryConfiguration, memCheckDbContext, userManager)
//    {
//    }
//    [Function(nameof(UpdateTagStats))]
//    public async Task Run([TimerTrigger(Constants.Cron_UpdateTagStats)] TimerInfo timer, FunctionContext context)
//    {
