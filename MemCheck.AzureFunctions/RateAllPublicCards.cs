...
{
    public RateAllPublicCards(TelemetryConfiguration telemetryConfiguration, MemCheckDbContext memCheckDbContext, MemCheckUserManager userManager, ILogger<RateAllPublicCards> logger)
