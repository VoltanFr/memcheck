...
{
    public RefreshAverageRatings(TelemetryConfiguration telemetryConfiguration, MemCheckDbContext memCheckDbContext, MemCheckUserManager userManager, ILogger<RefreshAverageRatings> logger)
