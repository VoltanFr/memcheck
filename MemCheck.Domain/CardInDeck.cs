...
namespace MemCheck.Domain
{
    public sealed class CardInDeck
    {
        ...
        public DateTime ExpiryUtcTime { get; set; }  //If CurrentHeap == 0, this is meaningless. Otherwise, this is the date on which the card expires. This information is computed by MoveCardToHeap, with the active heaping algorithm for the deck. In case the user changes the heaping algorithm of a deck, we need to recompute this information.
