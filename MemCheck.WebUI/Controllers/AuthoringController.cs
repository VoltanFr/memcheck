...
namespace MemCheck.WebUI.Controllers
{
    ...
    public class AuthoringController : MemCheckController
    {
        ...
        public async Task<IActionResult> GetImageInfo([FromBody] GetImageInfoRequest request)
        {
            ...
            var appResult = await new Application.Images.GetImageInfoFromName(callContext).RunAsync(new Application.Images.GetImageInfoFromName.Request(request.ImageName.Trim()), this);
