...
public partial class EmailModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostChangeEmailAsync()
    {
        ...
        if (Input.NewEmail != email)
        {
            ...
            await _emailSender.SendAsync(new MemCheckEmailAddress(Input.NewEmail, user.GetUserName()), localizer["ConfirmYourEmail"].Value, mailBody.ToString());
    ...
    public async Task<IActionResult> OnPostSendVerificationEmailAsync()
    {
        ...
        await _emailSender.SendAsync(email, localizer["ConfirmYourEmail"].Value, mailBody.ToString());
