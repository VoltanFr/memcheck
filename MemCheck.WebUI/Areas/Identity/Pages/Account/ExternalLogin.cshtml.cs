...
namespace MemCheck.WebUI.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public ExternalLoginModel(SignInManager<MemCheckUser> signInManager)
        {
        ...
        {
            ErrorMessage = "External login is not implemented.";
            ...
            //{
            //    var user = new MemCheckUser { UserName = Input.Email, Email = Input.Email };
